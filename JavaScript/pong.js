...
const boardBackground = "forestgreen"; // All the constant values needed
...
let paddle1 = { // Paddle objects on either end of the screen
    width: 25,
    height: 100,
    x: 0,
    y: 0
...
function checkCollision() {
    if (ballY<=0 + ballRadius) {
        ballYDirection *= -1; // Reverses ball direction when ball hits top of screen
    }
...
function resetGame() {
    player1Score=0;
    player2Score=0;
    paddle1 = { // Paddle objects on either end of the screen
        width: 25,
        height: 100,
        x: 0,
        y: 0
